import { getStorage } from '@iconizza/core/lib/storage/storage';
import { isPending, loadIcons } from '@iconizza/core/lib/api/icons';
...
import type { IconizzaIconName, IconizzaIcon } from '../iconizza';
...
export function scanDOM(rootNode?: ObservedNode, addTempNode = false): void {
	...
	interface GetIconResult {
		status: IconizzaElementData['status'];
		icon?: IconizzaIcon;
	}
	function getIcon(icon: IconizzaIconName, load: boolean): GetIconResult {
