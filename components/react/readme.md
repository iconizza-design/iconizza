...
Iconizza for React is not yet another icon component! There are many of them already.
...
For extended documentation visit [Iconizza for React documentation](https://iconizza.design/docs/icon-components/react/).
...
```bash
npm install --save-dev @iconizza/react
```

If you are using Yarn:

```bash
yarn add --dev @iconizza/react
```

## Usage with API

Install `@iconizza/react` and import `Icon` from it:

```typescript
import { Icon } from '@iconizza/react';
```
...
See [Iconizza for React icon names documentation](https://iconizza.design/docs/icon-components/react/icon-name.html) for more detailed explanation.
...
import { Icon, InlineIcon } from '@iconizza/react'
...
See [icon transformations documentation](https://iconizza.design/docs/icon-components/react/transform.html) for more details.
