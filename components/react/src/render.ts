 ...
 */
const inlineDefaults: Required<IconizzaIconCustomisations> = {
...
export const render = (
	...
	// Check mode
	const mode: IconizzaRenderMode = props.mode || 'svg';
	...
	if (mode === 'svg') {
		...
		componentProps.dangerouslySetInnerHTML = {
			__html: cleanUpInnerHTML(
				replaceIDs(
					item.body,
					id ? () => id + 'ID' + localCounter++ : 'iconizzaReact'
				)
			),
		};
