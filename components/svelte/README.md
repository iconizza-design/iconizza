...
Iconizza for Svelte is not yet another icon component! There are many of them already.
...
For extended documentation visit [Iconizza for Svelte documentation](https://iconizza.design/docs/icon-components/svelte/).
...
```bash
npm install --save-dev @iconizza/svelte
```

If you are using Yarn:

```bash
yarn add --dev @iconizza/svelte
```

## Usage with API

Install `@iconizza/svelte` and import `Icon` as default export from it:

```js
import Icon from '@iconizza/svelte'
```
...
See [Iconizza for Svelte icon names documentation](https://iconizza.design/docs/icon-components/svelte/icon-name.html) for more detailed explanation.
...
<script>
import Icon from '@iconizza/svelte';
import alertIcon from '@iconizza-icons/mdi/alert';
</script>
...
See [icon transformations documentation](https://iconizza.design/docs/icon-components/svelte/transform.html) for more details.
...
<script>
	...
	onMount(async () => {
		const promises = [
			import('@iconizza/svelte'), // Component
			import('@iconizza-icons/bi/link-45deg'), // Icon #1
		];
