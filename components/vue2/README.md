...
For extended documentation visit [Iconizza for Vue 2 documentation](https://iconizza.design/docs/icon-components/vue2/).
...
```bash
npm install --save-dev @iconizza/vue2
```

If you are using Yarn:

```bash
yarn add --dev @iconizza/vue2
```
...
If you are using Vue 3, you need to install `@iconizza/vue` component. It is almost identical to this component, but for Vue 3.

See [Iconizza for Vue 3 documentation](https://iconizza.design/docs/icon-components/vue/).

## Usage with API

Install `@iconizza/vue2` and import `Icon` from it:

```js
import { Icon } from '@iconizza/vue2'
```
...
See [Iconizza for Vue icon names documentation](https://iconizza.design/docs/icon-components/vue2/icon-name.html) for more detailed explanation.
...
See [icon transformations documentation](https://iconizza.design/docs/icon-components/vue2/transform.html) for more details.
...
For extended documentation visit [Iconizza for Vue documentation](https://iconizza.design/docs/icon-components/vue2/).
