...
import { initRedundancy } from '@iconizza/api-redundancy';
import {
	getAPIModule,
...
interface IconizzaAPIInternalStorage {
	config: IconizzaAPIConfig;
	redundancy: Redundancy;
}
const redundancyCache = Object.create(null) as Record<
	string,
	IconizzaAPIInternalStorage
>;
...
function getRedundancyCache(
	provider: string
): IconizzaAPIInternalStorage | undefined {
...
export function sendAPIQuery(
	...
	let send: IconizzaAPISendQuery | undefined;
