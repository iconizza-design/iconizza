 ...
 * Prepare params
 */
const prepare: IconizzaAPIPrepareIconsQuery = (
	provider: string,
	prefix: string,
	icons: string[]
): IconizzaAPIIconsQueryParams[] => {
	...
	// Split icons
	const type = 'icons';
	let item: IconizzaAPIIconsQueryParams = {
		type,
		provider,
		prefix,
		icons: [],
 ...
 * Load icons
 */
const send: IconizzaAPISendQuery = (
	host: string,
 ...
 * Export module
 */
export const fetchAPIModule: IconizzaAPIModule = {
	prepare,
	send,
};
