 ...
 * List of icons
 */
type IconRecords = Record<string, IconizzaIcon>;
 ...
 */
export function addIconSet(storage: IconStorage, data: IconizzaJSON): string[] {
	if (!quicklyValidateIconSet(data)) {
		return [];
	}

	return parseIconSet(data, (name: string, icon: IconizzaIcon | null) => {
		if (icon) {
