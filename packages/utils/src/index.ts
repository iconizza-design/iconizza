...
export type { IconizzaIconName, IconizzaIconSource } from './icon/name';
...
export type {
	IconizzaIcon,
	FullIconizzaIcon,
	PartialExtendedIconizzaIcon,
	FullExtendedIconizzaIcon,
} from './icon/defaults';
...
export type { IconizzaIconBuildResult } from './svg/build';
