import type { IconizzaIcon } from '../icon/defaults'
 ...
 */
export interface IconizzaIconBuildResult {
   attributes: {
      // Attributes for <svg>
      width?: string
      height?: string
 ...
 */
export function isUnsetKeyword(value: unknown) {
...
export function iconToSVG(
   ...
   const attributes = {} as IconizzaIconBuildResult['attributes']
