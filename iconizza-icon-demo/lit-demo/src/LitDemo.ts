...
import { addIcon, addCollection, disableCache } from 'iconizza-icon';
import calendarIcon from '@iconizza-icons/line-md/calendar';

import accountIcon from '@iconizza-icons/line-md/account';
import alertIcon from '@iconizza-icons/line-md/alert';
...
export class LitDemo extends LitElement {
	@property({ type: String }) title = 'IconizzaIcon Demo';
	...
	static styles = css`
		...
		.test-row-icons > iconizza-icon {
			color: #afafaf;
			display: none;
		}
		.test-row-icons > iconizza-icon.hidden {
			display: none !important;
		}
		.test-row-icons > iconizza-icon.visible {
			display: inline-block;
		}
		.test-row-icons > iconizza-icon.success {
			color: #327335;
		}
		.test-row-icons > iconizza-icon.failed {
			color: #ba3329;
		}

		/* 24px icon */
		.icon-24 iconizza-icon {
			font-size: 24px;
			line-height: 1;
		...
		.checkbox--checked iconizza-icon {
			color: #327335;
		}
		.checkbox:hover iconizza-icon {
			color: inherit;
		}
		...
		return html`
			<section class="icon-24">
				...
				<div>
					...
					<iconizza-icon icon="mdi:home"></iconizza-icon>
					<iconizza-icon icon="mdi:home" mode="style"></iconizza-icon>
				</div>
				<div class="alert">
					<iconizza-icon icon="mdi-light:alert"></iconizza-icon>
			...
			<section class="icon-24">
				...
				<div>
					Icons referenced by name (as SVG, as SPAN):
					<iconizza-icon icon="demo"></iconizza-icon>
					<iconizza-icon icon="demo" mode="style"></iconizza-icon>
				</div>
				<div>
					Icons referenced by stringified object (as SVG, as SPAN):
					<iconizza-icon icon="${JSON.stringify(accountIcon)}"></iconizza-icon>
					<iconizza-icon
				...
				<div>
					...
					<iconizza-icon icon="test:alert1"></iconizza-icon>
					<iconizza-icon icon="test:link1" mode="style"></iconizza-icon>
				</div>
				<div class="alert">
					<iconizza-icon
			...
			<section class="inline-demo">
				...
				<div>
					...
					<iconizza-icon icon="experiment2"></iconizza-icon>
					<iconizza-icon
						icon="experiment2"
						inline
				...
				<div>
					...
					<iconizza-icon icon="experiment2" inline></iconizza-icon>
					<iconizza-icon
						icon="experiment2"
