<template>
	<div>
		<span>
			<iconizza-icon icon="mdi-animated:coffee" inline />
			Icon used by name (preloaded)
		</span>
		<span>
			<iconizza-icon icon="mdi:email" inline />
			Icon used by name (loaded from API)
		</span>
		<span>
			<iconizza-icon :icon="testIcon" inline />
...
<script lang="ts">
import { disableCache, addIcon } from 'iconizza-icon';
