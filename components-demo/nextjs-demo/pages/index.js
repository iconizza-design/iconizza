...
import { Icon, InlineIcon, addIcon, getIcon, loadIcons } from '@iconizza/react'

// Use Iconizza to render logo
addIcon('logo', {
   width: 283,
   height: 64,
      ...
      <div className="container">
            ...
            <div className="grid">
               <a href="https://nextjs.org/docs" className="card">
                  <h3>
                     Documentation
                     {' '}
                     <InlineIcon icon="mdi:arrow-right" />
                  </h3>
                  <p>
         ...
         <footer>
            ...
            >
               Powered by
               {' '}
               <Icon icon="logo" alt="Vercel Logo" />
            </a>
         </footer>
