<script>
	import { addIcon as addOfflineIcon, addCollection as addOfflineCollection } from '@iconizza/svelte/dist/OfflineIcon.svelte';
	import {
		addIcon as addOnlineIcon,
		addCollection as addOnlineCollection,
		disableCache,
	} from '@iconizza/svelte';

	import presentationPlay from '@iconizza-icons/mdi-light/presentation-play';
	import playIcon from '@iconizza-icons/mdi-light/play';
