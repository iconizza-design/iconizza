...
import { InlineIcon } from '@iconizza/react/dist/offline';
import successIcon from '@iconizza-icons/uil/check-circle';
import pendingIcon from '@iconizza-icons/uil/question-circle';
import failedIcon from '@iconizza-icons/uil/times-circle';
