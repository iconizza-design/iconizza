...
import { InlineIcon, addAPIProvider, _api } from '@iconizza/react';
import {
	mockAPIModule,
	mockAPIData,
} from '@iconizza/core/lib/api/modules/mock';
import { TestIcons, toggleTest } from './TestIcons';
import playIcon from '@iconizza-icons/mdi-light/map-marker';
