# Iconizza Icon for Solid

Iconizza Icon web component is a wrapper for `iconizza-icon` package, which provides SolidJS component and typings.
...
```bash
npm install --save-dev @iconizza-icon/solid
```

If you are using Yarn:

```bash
yarn add --dev @iconizza-icon/solid
```

## Usage

Install `@iconizza-icon/solid` and import `Icon` from it:

```typescript
import { Icon } from '@iconizza-icon/solid';
```
